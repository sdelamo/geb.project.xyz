...
(function (define) {
  ...
  (function (root, factory) {
    ...
    return (function () {
	  ...
	  /**
	   * A utility function to check to see if something is a DOM object
      ...
      function render(self) {
        ...
        var renderLeaf = function (item) {
          ...
          expando.innerHTML = item.expanded ? openIcon : closeIcon;
